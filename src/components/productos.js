...
export const Productos = () => {
  ...
  // );
    ...
    <div  className="d-flex flex-row justify-content-between me-5  ms-5 h-100 align-items-center" id="sectionProductos">
    
      <div className="card tarjeta-custom"  >
        <img src={mplogo} className="card-img-top p-5 h-25" alt="..."></img>
          <div class="card-body ">
              <h5 class="card-title text-center">Checkout MercadoPago</h5>
  ...
  <img src={wsplogo} className="card-img-top p-5" alt="..."></img>
    <div class="card-body">
      <h5 class="card-title text-center">Bot de whatsapp</h5>
  ...
  <img src={weblogo} className="card-img-top p-3" alt="..."></img>
    <div class="card-body">
      <h5 class="card-title text-center">Preparamos Tu Web</h5>
