...
return(
    ...
    <div  className="col m-2 bg-custom h-75 flex-column justify-content-center d-flex align-items-center p-3 rounded custom-nosotros shadow-lg">
        ...
        <p className="text-center ">Somos apasionados por la tecnolgia, al servicio de tu necesidad.</p>     
    </div>

    <div  className="col m-2 bg-custom h-75 flex-column justify-content-center d-flex align-items-center p-3 rounded custom-nosotros shadow-lg ">
        <h2 className="text-light text-center text-uppercase fs-4"> ¿Que hacemos?  </h2>
        <p className="text-center align-middle ">Brindammos soluciones tecnologicas para que vos y tu negocio sigan creciendo.</p>
    </div> 
    
    <div   className="col m-2 bg-custom h-75 flex-column justify-content-center d-flex align-items-center p-3 rounded custom-nosotros shadow-lg">
        <h2 className="text-light text-center text-uppercase fs-5"> ¿Por qué elegirnos? </h2>
        <p className="text-center">Tenemos compromiso y estamos abiertos a los cambios tecnologicos.</p>
    <div>
