...
<div className=" bg-custom h-100 p-5 d-flex flex-column justify-content-center align-items-center rounded color-text-custom form-custom " id="sectionContacto">
...
<label for="exampleFormControlInput1" className="form-label  w-100 mt-2">Email</label>

    <input type="email" className="form-control " id="exampleFormControlInput1" placeholder="name@example.com"></input>

    <label for="exampleFormControlInput1" className="form-label  w-100 mt-2">Motivo</label>
...
<button type="submit" className="btn btn-outline-light w-50 mt-3">Enviar</button>       
</div>
