            ...
            <div className="row w-100 justify-content-center">
                ...
                <div className="col-12 mb-md-0 mb-3  link-redes  ">
                    ...
                    <ul className="list-unstyled d-flex flex-row justify-content-evenly">
                        ...
                        <li><a href="https://www.instagram.com/neuroticaitgirl/" target="_blank"><i class="fa-brands fa-square-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/neuroticaitgirl/" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
